...
public class HeadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HeadActivity.this, SelfActivity.class);
                startActivity(intent);
            }
        });

        headSymptom = findViewById(R.id.et_symptom);
        ...
        headSymptom.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                if (dataMap != null) {
                    for (Map.Entry<String, Object> entry : dataMap.entrySet()) {
                        if (entry.getValue() instanceof Map) {
                            ...
                            if (innerMap.containsKey("머리")) {
                                String symptom = innerMap.get("머리").toString();
        ...
        if (btnSubmit != null) {
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String symptom = headSymptom.getText().toString();
                    ...
                    headSymptom.setText(""); // EditText 내용 지우기
                }
            });
        }
    }
    ...
    private void addOrUpdateSymptomView(String date, String symptom) {
        ...
        if (symptomView == null) {
            symptomView = new TextView(HeadActivity.this);
