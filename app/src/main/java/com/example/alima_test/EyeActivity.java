...
public class EyeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EyeActivity.this, SelfActivity.class);
                startActivity(intent);
            }
        });

        eyeSymptom = findViewById(R.id.et_symptom);
        ...
        eyeSymptom.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                if (dataMap != null) {
                    for (Map.Entry<String, Object> entry : dataMap.entrySet()) {
                        if (entry.getValue() instanceof Map) {
                            ...
                            if (innerMap.containsKey("눈")) {
                                String symptom = innerMap.get("눈").toString();
        ...
        if (btnSubmit != null) {
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String symptom = eyeSymptom.getText().toString();
                    ...
                    eyeSymptom.setText(""); // EditText 내용 지우기
                }
            });
        }
    }
    ...
    private void addOrUpdateSymptomView(String date, String symptom) {
        ...
        if (symptomView == null) {
            symptomView = new TextView(EyeActivity.this);
