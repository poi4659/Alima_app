...
public class NoseActivity extends AppCompatActivity {

    private EditText noseSymptom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NoseActivity.this, SelfActivity.class);
                startActivity(intent);
            }
        });

        noseSymptom = findViewById(R.id.et_symptom);
        ...
        noseSymptom.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                if (dataMap != null) {
                    for (Map.Entry<String, Object> entry : dataMap.entrySet()) {
                        if (entry.getValue() instanceof Map) {
                            ...
                            if (innerMap.containsKey("코")) {
                                String symptom = innerMap.get("코").toString();
        ...
        if (btnSubmit != null) {
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String symptom = noseSymptom.getText().toString();
                    ...
                    noseSymptom.setText(""); // EditText 내용 지우기
                }
            });
        }
    }
    ...
    private void addOrUpdateSymptomView(String date, String symptom) {
        ...
        if (symptomView == null) {
            symptomView = new TextView(NoseActivity.this);
