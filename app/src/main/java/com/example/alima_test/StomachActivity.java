...
public class StomachActivity extends AppCompatActivity {
    ...
    private EditText stomachSymptom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StomachActivity.this, SelfActivity.class);
                startActivity(intent);
            }
        });

        stomachSymptom = findViewById(R.id.et_symptom);
        ...
        stomachSymptom.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                if (dataMap != null) {
                    for (Map.Entry<String, Object> entry : dataMap.entrySet()) {
                        if (entry.getValue() instanceof Map) {
                            ...
                            if (innerMap.containsKey("배")) {
                                String symptom = innerMap.get("배").toString();
        ...
        if (btnSubmit != null) {
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String symptom = stomachSymptom.getText().toString();
                    ...
                    stomachSymptom.setText(""); // EditText 내용 지우기
                }
            });
        }
    }
    ...
    private void addOrUpdateSymptomView(String date, String symptom) {
        ...
        if (symptomView == null) {
            symptomView = new TextView(StomachActivity.this);
