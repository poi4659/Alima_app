...
public class LegsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LegsActivity.this, SelfActivity.class);
                startActivity(intent);
            }
        });

        legsSymptom = findViewById(R.id.et_symptom);
        ...
        legsSymptom.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                if (dataMap != null) {
                    for (Map.Entry<String, Object> entry : dataMap.entrySet()) {
                        if (entry.getValue() instanceof Map) {
                            ...
                            if (innerMap.containsKey("다리")) {
                                String symptom = innerMap.get("다리").toString();
        ...
        if (btnSubmit != null) {
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String symptom = legsSymptom.getText().toString();
                    ...
                    legsSymptom.setText(""); // EditText 내용 지우기
                }
            });
        }
    }
    ...
    private void addOrUpdateSymptomView(String date, String symptom) {
        ...
        if (symptomView == null) {
            symptomView = new TextView(LegsActivity.this);
